package com.bluetoothandroid.mcasey.BluetoothService;
...
import com.bluetoothandroid.mcasey.UI.MainActivity;
...
public class BluetoothService {
    ...
    public synchronized void connected(BluetoothSocket socket, final String socketType) {
        ...
        bundle.putString(MainActivity.DEVICE_NAME, sBluetoothDevice.getName());
        msg.setData(bundle);
